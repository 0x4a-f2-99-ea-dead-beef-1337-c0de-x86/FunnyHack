...
SettingsSection:Button({
	...
	Callback = function()
		...
		pcall(function() ESP:Exit() end)
		pcall(function() Aimbot:Exit() end)
		getgenv().ShyzosV1Loaded = nil
	end
})
...
InformationSection:Label("Made by Shyzuu")

InformationSection:Label("ShyzosCorp © 2025 - "..osdate("%Y"))

ESP.Load()
Aimbot.Load()
getgenv().ShyzosV1Loaded = true
getgenv().ShyzosV1Loading = nil
